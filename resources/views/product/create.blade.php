                ...
                <div class="card-body">
                    ...
                    @csrf
                        <div class="col-12 pb-2">
                          ...
                          <textarea name="name" type="text" class="form-control" id="inputName" rows="1" placeholder="Product Name " required></textarea>
                          @if ($errors->has('name'))
                        ...
                        <div class="col-12 pb-2">
                            ...
                            <textarea name="description" type="text" class="form-control" id="inputDescription" rows="5" required></textarea>
                        ...
                        <div class="col-12 pb-2">
                            ...
                            <textarea name="category" type="text" class="form-control" id="inputCategory" rows="5" required></textarea>
